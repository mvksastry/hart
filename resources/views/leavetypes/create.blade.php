										...
										<div class="card-body">
											...
											@csrf
												...
												<div class="form-group">
												  ...
												  name="leavetype_name" id="leavetype_name" placeholder="Leave Type Name">
												</div>
												...
												<div class="form-group">
												  ...
												  <input type="text" class="form-control form-control-border" 
												  name="leave_limit_peryear" id="leave_limit_peryear" placeholder="Limit">
												</div>
												...
												<div class="form-group">
												  ...
												  <input type="text" class="form-control form-control-border" 
												  name="leave_conditions" id="leave_conditions" placeholder="Conditions">
												</div>
												...
												<div class="custom-control custom-checkbox">
												  <input class="input" type="checkbox" name="needs_permission" id="needs_permission" value="1">
												...
												<div class="form-group">
												  ...
												  <select class="custom-select form-control-border" name="eligible_gender_id" id="eligible_gender_id">
												...
												<div class="form-group">
												  ...
												  <input type="text" class="form-control form-control-border" 
												  name="carried_on_limit" id="carried_on_limit" placeholder="Carry Forward Limit">
												</div>
												...
												<div class="form-group">
												  ...
												  <input type="text" class="form-control form-control-border" 
												  name="cumulative_ceiling" id="cumulative_ceiling" placeholder="Ceiling Limit">
												</div>
