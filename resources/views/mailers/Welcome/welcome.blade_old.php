                          ...
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                              <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                Hello {{ $contactMailData['name'] }}!<br></br>
                                Thank you for contacting H A R T. We're really happy to have you! 
                          ...
                          <tr>
                            <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-bottom:50px;word-break:break-word;">
                              <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                  <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                    <p>We have a number of applications that help run an office without paper.
                    Does not matter where you are present yet you can complete all your work!</p>
                    <p>We Are a Human & Administrative Resource Tracker office software company.
                    Our software helps you manage and run your office with lease IT infrastructure.
                    Simply sign-up and start using it right away. 
                    It is that <span>Simple</span> &amp; <span>Easy</span> It is on Cloud.
                    </p>
                                  </td>
                                </tr>
                              </table>
                          ...
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                              <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                Best regards,<br><br> Krishna Teja M<br>Meissa Software Solutions., CEO and Founder<br>
                                <a href="https://www.elabmeissa.co.in" style="color:#2F67F6">HART Meissa</a>
                              </div>
                            </td>
                          </tr>
                        </table>
