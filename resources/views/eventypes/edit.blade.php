	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Edit Event Type</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
							<li class="breadcrumb-item active">Edit Event Type</li>
						</ol>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.container-fluid -->
							...
							<div class="card-body">
								<div class="tab-content p-0">
									...
									<div class="card card-primary">
										...
										<!-- /.card-header -->
										<div class="card-body">
											<form method="POST" action="{{ route('eventypes.update', $eventypes->eventype_id) }}">
												@csrf
												@method('PUT')
												...
												<div class="form-group">
													...
													<input type="text" class="form-control form-control-border" 
														name="eventname" id="eventname" value="{{ $eventypes->eventname }}">
												</div>
												...
												<div class="form-group">
													...
													<input type="date" class="form-control form-control-border" 
														name="eventdate" id="eventdate" value="{{ $eventypes->eventdate }}">
												</div>
												...
												<div class="form-group">
													<div class="col-sm-12">
														...
														name="description" id="description" value="{{ $eventypes->description }}">
													</div>
												</div>
