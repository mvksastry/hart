...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('blogs.posts',compact('page_title','posts'));
    }
    ...
    public function create()
    {
        ...
        return view('blogs.adds.addpost',compact('page_title'));
    }
    ...
    public function show($slug)
    {
        ...
        if($data){
            ...
            return view('blogs.details.viewpost',compact('data','page_title'));
        }
        else{
    ...
    public function edit($slug)
    {
        ...
        if($data){
            ...
            return view('blogs.edits.editpost',compact('data','page_title'));
        }
        else{
            return redirect()->back()->with('msg','Post not found');
        }
